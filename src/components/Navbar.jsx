  ...
  return (
    <header
      className={[
        ...
        scrolled
          ? 'bg-blue-900/95 backdrop-blur-md shadow-lg border-b border-yellow-400/25 py-3'
          : 'bg-blue-900 shadow-md py-4',
      ].join(' ')}
    >
      <nav className="max-w-6xl mx-auto px-6 lg:px-8 flex justify-between items-center gap-4">
        <Link
          to="/"
      ...
      <div
        className={[
          ...
          scrolled ? 'bg-blue-900/95' : 'bg-blue-900',
        ].join(' ')}
      >
